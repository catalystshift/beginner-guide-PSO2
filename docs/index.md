...
While we do recommend reading through the guide, PSO2 is exceedingly simple to just get started with. 
...
After completing tutorial you will find yourself in the Gate Area, and be shown an introductory video which will also mention **ARKS Missions**. These are important.
...
Firstly: **Rainbows only on characters above level 80**. This, is, important. OK, carry on.
